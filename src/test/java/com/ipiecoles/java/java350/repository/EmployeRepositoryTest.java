...
public class EmployeRepositoryTest {
	    ...
	    public void testFindByImmat(){
	        ...
	        Employe emp = employeRepository.save(new Employe("emp1", "emp1", "X99999", LocalDate.now(), 2500.00, 3, 1.00));
	        Employe emp2 = employeRepository.save(new Employe("emp2", "emp2", "X33333", LocalDate.now().minusMonths(8), 2500.00, 3, 1.00));

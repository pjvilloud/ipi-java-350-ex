...
public class EmployeAcceptanceTest {
    ...
    public void calculPerf(String matricule, Integer performance, Long caTraite, Long objectif) throws EmployeException {
        Employe e = employeRepository.findByMatricule(matricule);
    ...
    public void nouvellePerf(String matricule, Integer performance) {
        Employe e = employeRepository.findByMatricule(matricule);
    ...
    public void IntegrationEmployeAvecPerf(String prenom, String nom, String matricule, Integer performance) throws EmployeException {

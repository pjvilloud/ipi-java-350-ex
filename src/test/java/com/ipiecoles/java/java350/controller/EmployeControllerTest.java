...
//
//        //Given
//        Employe employe = new Employe("Doe", "John", "T00001", LocalDate.now(),
//                                            1500d, 1, 1.0);
//        employe.setId(5L);
//
...
//
//        //Then
//        result.andExpect(status().isOk()).andExpect(content().json("{'id':5, 'nom':'Doe', 'prenom':'John', 'matricule':'T00001', " +
...
//
//    @Test
//    public void testEmployeNotFound() throws Exception{
//
//        //Given
...
//
//        //Then
//        result.andExpect(status().isNotFound()).andExpect(content().string("Employe introuvable"));
//    }

...
public class EmployeService {
    ...
    public void embaucheEmploye(String nom, String prenom, Poste poste, NiveauEtude niveauEtude, Double tempsPartiel) throws EmployeException, EntityExistsException {
        logger.info("Tentative d'embauche d'un employe avec les paramètres : {}, {}, {}, {},{}",nom,prenom,poste,niveauEtude,tempsPartiel);
        ...
        if (numeroMatricule >= 100000) {
            logger.error("Le numero de Matricule est > 100000");
    ...
    public void calculPerformanceCommercial(String matricule, Long caTraite, Long objectifCa) throws EmployeException {
        ...
        //Cas 5
        // Pit ne passe pas ici car il change le * en / et ici sur un > si on remplace le * par / c'est autant plus vrai.
        // Il ne passe pas aussi car il test si l'opération est vrai si on remplace > par >= or on a déja un = objectifCa * 1.2
        // juste au dessus donc si l'on veux tester le cas il passe dans la condition d'avant.

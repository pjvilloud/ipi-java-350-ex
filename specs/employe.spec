...
## Embauche d'un technicien à plein temps un avec un CAP
* J'embauche une personne appelée "John" "Doe" diplômée d'un "CAP" en tant que "Technicien" à "temps plein".
* J'obtiens un nouvel employé appelé "John" "Doe" portant le matricule "T00001" et touchant un salaire de "1521.22"€.
